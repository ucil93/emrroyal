...
<![endif]-->
        ...
        <!-- Script Data Master -->
        <script src="<?php echo base_url(); ?>assets/scripts/header_rawin.js" type="text/javascript" ></script>

        <script src="<?php echo base_url(); ?>assets/scripts/emr_rawin.js" type="text/javascript" ></script>
