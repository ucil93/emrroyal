            <div class="page-footer bg-blue-chambray" >
              <?php $tahun = date('Y'); ?>
              <div class="page-footer-inner"> <?php echo $tahun; ?> &copy; TIM IT RS. PETROKIMIA GRESIK
...
<![endif]-->
        ...
        <!-- Script Data Master -->
        <script src="<?php echo base_url(); ?>assets/scripts/header_labo.js" type="text/javascript" ></script>
        <script src="<?php echo base_url(); ?>assets/scripts/master_gr_laborat.js" type="text/javascript" ></script>
        <script src="<?php echo base_url(); ?>assets/scripts/master_dt_laborat.js" type="text/javascript" ></script>
        <script src="<?php echo base_url(); ?>assets/scripts/data_pasien_laborat.js" type="text/javascript" ></script>
