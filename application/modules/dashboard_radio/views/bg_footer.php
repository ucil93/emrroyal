...
<![endif]-->
        ...
        <!-- Script Data Master -->
        <script src="<?php echo base_url(); ?>assets/scripts/header_radio.js" type="text/javascript" ></script>
        <script src="<?php echo base_url(); ?>assets/scripts/master_gr_radio.js" type="text/javascript" ></script>
        <script src="<?php echo base_url(); ?>assets/scripts/master_dt_radio.js" type="text/javascript" ></script>
        <script src="<?php echo base_url(); ?>assets/scripts/data_pasien_radio.js" type="text/javascript" ></script>
