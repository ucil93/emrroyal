            ...
            <div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_Halaman3">
              ...
              <div class="col-md-7 portlet light bordered">
                <div class="portlet-body">
                  <div class="tab-content">
                    <div class="col-md-12">
                      <img id="EMR_ASESMEN_AWAL_emoticon" src="<?php echo base_url().'assets/pages/img/emoticon/1.png'?>">
                      <!--<span id="EMR_ASESMEN_AWAL_emoticon"></span>-->
                    </div>
                    <div class="col-md-12">
                      Skor Nyeri :
                    ...
                    <div class="col-md-12">
                      ...
                      <span id="EMR_ASESMEN_PERAWAT_SkalaNyeri"><b> Nyeri ringan sampai tidak nyeri</b></span>
                    </div>
                  </div>
                </div>
              </div>
