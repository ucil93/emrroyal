...
<script src="<?php echo base_url(); ?>assets/scripts/canvas.js" type="text/javascript" ></script>
<script src="<?php echo base_url(); ?>assets/scripts/emr_poli_tulang.js" type="text/javascript" ></script>
<!--<script src="<?php echo base_url(); ?>assets/scripts/printOut.js" type="text/javascript" ></script>-->
