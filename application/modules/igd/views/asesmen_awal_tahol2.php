              ...
              <div class="portlet light bordered form-body">
                <div class="row">
                        ...
                        <div class="portlet-body">
                          <div class="tab-content">
                            <div class="row" style="display: block; margin-top: 0em; margin-bottom: 0em;">
                              <!--<div class="col-md-12">
                                <label class="success">TD</label>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon right" style="display: block; margin-top: 0em; margin-bottom: -1em;">
                                        <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" maxlength="3">
                  ...
                  <div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_Halaman3">
                    <!--<div class="col-md-12">
                      <div class="col-md-12 portlet light bordered">
                        <span>Apakah Pasien Memiliki Resiko Jatuh?</span>

                        <div class="form-group">
                          <div class="input-group">
                            <div class="md-radio-inline">
                              <div class="md-radio">
                                <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnResikoYA" name="EMR_ASESMEN_PERAWAT_RbtnResiko" class="md-radiobtn">
                                <label for="EMR_ASESMEN_PERAWAT_RbtnResikoYA">
                                <span></span>
                                <span class="check"></span>
                                <span class="box"></span> YA </label>
                              </div>
                              <div class="md-radio">
                                <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnResikoTIDAK" name="EMR_ASESMEN_PERAWAT_RbtnResiko" class="md-radiobtn">
                                <label for="EMR_ASESMEN_PERAWAT_RbtnResikoTIDAK">
                                <span></span>
                                <span class="check"></span>
                                <span class="box"></span> TIDAK </label>
                              </div>
                        ...
                        <input type="hidden" id="Resikostatus" value="Tidak" class="form-control">
                        <div class="portlet-body">
                          <div class="tab-content">
                            ...
                            <div class="row" style="display: block; margin-top: 0em; margin-bottom: 0em;">
                              <div class="col-md-12">
                                ...
                                <div class="row md-radio-inline">
                                    ...
                                    <!--<button type="button" id="coba" class="btn white" style="width:50%"><< Kembali</button>-->
                                </div>
                                ...
                                <!--<div id="EMR_ASESMEN_PERAWAT_InputAlatBantu" class="form-group collapse">
                                  <label for="form_control_1">Masukkan Bahasa</label>
                                  <label for="form_control_1">Masukkan Alat Bantu</label>
                                  <input type="text" id="alatbantu" name="alatbantu" value="" class="form-control" maxlength="30" placeholder="Alat bantu yang digunakan pasien">

                                  <input type="text" id="alatbantustatus" value="Tidak" class="form-control">
                                </div>-->
                      ...
                      <div class="col-md-12 portlet light bordered">
                        <div class="portlet-body">
                          <div class="tab-content">
                            ...
                            <!--<div class="col-md-12" id="EMR_ASESMEN_PERAWAT_FungTindakan2">
                            <div class="col-md-12">
                              <div class="md-checkbox">
                                ...
                                <span></span>
                                <span class="check"></span>
                                <span class="box"></span> <label id="EMR_ASESMEN_PERAWAT_TindakanSudah"><b> Klik disini apabila Pasien tidak memiliki resiko jatuh </b></label></label>
                              </div>
                            </div>-->
                        ...
                        <div class="tab-content">
                          <div class="md-radio-inline">
                            <div class="col-md-5 md-radio">
                              <input type="radio" id="EMR_ASESMEN_PERAWAT_SN1Ada" name="EMR_ASESMEN_PERAWAT_adaNyeri" value="" class="md-check">
                              <label for="EMR_ASESMEN_PERAWAT_SN1Ada">
                              <span></span>
                              <span class="check"></span>
                              <span class="box"></span> Ada nyeri </label>
                            </div>
                            <div class="col-md-5 md-radio">
                              <input type="radio" id="EMR_ASESMEN_PERAWAT_SN1Takda" name="EMR_ASESMEN_PERAWAT_adaNyeri" value="" class="md-check">
                              <label for="EMR_ASESMEN_PERAWAT_SN1Takda">
                              <span></span>
                              <span class="check"></span>
                              <span class="box"></span> Tidak ada nyeri</label>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="tab-content">
                            ...
                            {?>
                              ...
                              <div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_SN3_3">
                                ...
                                <input type="text" id="EMR_ASESMEN_PERAWAT_SNMenjalar2" name="EMR_ASESMEN_PERAWAT_SNMenjalar2" value="" class="form-control collapse" maxlength="30" placeholder="Lokasi jalar">-->
                              </div>
                              <div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_SN3_4">
                                ...
                                <div class="row">
                                  <div class="btn-group btn-group-solid" style="width:100%">
                                    <!--<button class="btn btn-default" id="EMR_ASESMEN_PERAWAT_btnSN3A_1"><img src="<?php echo base_url().'assets/pages/img/icon/emot001.png'?>" style="height:50px"></button>-->
                                ...
                                <!--<div class="btn-group btn-group-solid" style="width:100%">
                                  <label class="btn btn-white center"><img src="<?php echo base_url().'assets/pages/img/icon/emot001.png'?>" style="height:50px"></label>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3A_1" class="btn white" style="height:80px;"></button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3A_2" class="btn white" style="height:80px;"><img src="<?php echo base_url().'assets/pages/img/icon/emot002.png'?>" style="height:50px"></button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3A_3" class="btn white" style="height:80px;"><img src="<?php echo base_url().'assets/pages/img/icon/emot003.png'?>" style="height:50px"></button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3A_4" class="btn white" style="height:80px;"><img src="<?php echo base_url().'assets/pages/img/icon/emot004.png'?>" style="height:50px"></button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3A_5" class="btn white" style="height:80px;"><img src="<?php echo base_url().'assets/pages/img/icon/emot005.png'?>" style="height:50px"></button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3A_6" class="btn white" style="height:80px;"><img src="<?php echo base_url().'assets/pages/img/icon/emot006.png'?>" style="height:50px"></button>
                                </div>
                                </br>
                                </br>
                                <div class="btn-group btn-group-solid" style="width:100%">
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_0" class="btn white" style="height:40px; width:80px;">0</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_1" class="btn white" style="height:40px;">1</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_2" class="btn white" style="height:40px; width:60px;">2</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_3" class="btn white" style="height:40px;">3</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_4" class="btn white" style="height:40px; width:60px;">4</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_5" class="btn white" style="height:40px;">5</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_6" class="btn white" style="height:40px; width:60px;">6</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_7" class="btn white" style="height:40px;">7</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_8" class="btn white" style="height:40px; width:60px;">8</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_9" class="btn white" style="height:40px;">9</button>
                                  <button type="button" id="EMR_ASESMEN_PERAWAT_btnSN3B_10" class="btn white" style="height:40px; width:60px;">10</button>
                                </div>-->
                              </div>
                              ...
                              <!--<div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_SN3_5">
                                ...
                                <div class="form-group">
                                  <div class="input-group">
                                    <div class="md-radio-inline">
                                      ...
                                      <div class="md-radio">
                                        <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnSNsetiap4" name="EMR_ASESMEN_PERAWAT_RbtnSNsetiap" class="md-radiobtn">
                                        <label for="EMR_ASESMEN_PERAWAT_RbtnSNsetiap4">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box"></span> terus menerus</label>
                                      </div>
                                ...
                                <div class="collapse" id="setiapselamaapa">
                                  <input type="hidden" id="ststsetiapselamaapa" value="tidak">
                                  <span>berapa waktu lamanya anda merasakan nyeri?</span>
                                  <center>
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="md-radio-inline">
                                        <div class="md-radio">
                                          <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnSNselama1" name="EMR_ASESMEN_PERAWAT_RbtnSNselama" class="md-radiobtn">
                                          <label for="EMR_ASESMEN_PERAWAT_RbtnSNselama1">
                                          <span></span>
                                          <span class="check"></span>
                                          <span class="box"></span> < 30 menit </label>
                                        ...
                                        <div class="md-radio">
                                          <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnSNselama2" name="EMR_ASESMEN_PERAWAT_RbtnSNselama" class="md-radiobtn">
                                          <label for="EMR_ASESMEN_PERAWAT_RbtnSNselama2">
                                          <span></span>
                                          <span class="check"></span>
                                          <span class="box"></span> > 30 menit </label>
            ...
            <div class="col-md-12">
              <div class="portlet light bordered form-body">
                <div class="row">
                          ...
                          <div class="portlet-body">
                            <table class="col-md-12">
                              ...
                              <tr>
                                ...
                                <td class="col-md-3"><button type="button" id="EMR_ASESMEN_DOKTER_btnAnemisKanan" class="btn yellow col-md-12" value="-"><b> - </b></button></td>
                                <td class="col-md-3"><button type="button" id="EMR_ASESMEN_DOKTER_btnAnemisKiri" class="btn yellow col-md-12" value="-"><b> - </b></button></td>
                              </tr>
                              <tr>
                                <td class="col-md-6"><span><center>Ikterus</center></span></td>
                                <td colspan="2" class="col-md-6"><button type="button" id="EMR_ASESMEN_DOKTER_btnIkterus" class="btn yellow col-md-12" value="-"><b> - </b></button></td>
                              </tr>
                              <tr>
                                <td class="col-md-6"><span><center>Cyanosis</center></span></td>
                                <td colspan="2" class="col-md-6"><button type="button" id="EMR_ASESMEN_DOKTER_btnCyanosis" class="btn yellow col-md-12" value="-"><b> - </b></button></td>
                              </tr>
                              <tr>
                                <td class="col-md-6"><span><center>Dipsneo</center></span></td>
                                <td colspan="2" class="col-md-6"><button type="button" id="EMR_ASESMEN_DOKTER_btnDipsneo" class="btn yellow col-md-12" value="-"><b> - </b></button></td>
                              </tr>
                              <?php
                              if($Utahun < 1.5)
                              { ?>
                              ...
                              <tr>
                                ...
                                <td class="col-md-3"><input type="text" id="EMR_ASESMEN_DOKTER_pupilKanan" class="form-control col-md-12" value="3"></td>
                                <td class="col-md-3"><input type="text" id="EMR_ASESMEN_DOKTER_pupilKiri" class="form-control col-md-12" value="3"></td>
                              </tr>
                              <tr>
                          ...
                          <div class="portlet-body">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                <div class="row md-checkbox-inline">
                                  <div class="col-md-5 md-checkbox">
                                    <input type="checkbox" id="EMR_ASESMEN_DOKTER_Cor1" name="" value="" class="md-check">
                                  ...
                                  <div class="col-md-5 md-checkbox">
                                    <input type="checkbox" id="EMR_ASESMEN_DOKTER_Cor2" name="" value="" class="md-check">
                                  ...
                                  <div class="col-md-5 md-checkbox">
                                    <input type="checkbox" id="EMR_ASESMEN_DOKTER_Cor3" name="" value="" class="md-check">
                                ...
                                <div class="row md-checkbox-inline">
                                  <div class="col-md-5 md-checkbox">
                                    <input type="checkbox" id="EMR_ASESMEN_DOKTER_Cor4" name="" value="" class="md-check">
                                  ...
                                  <div class="col-md-5 md-checkbox">
                                    <input type="checkbox" id="EMR_ASESMEN_DOKTER_Cor5" name="" value="" class="md-check">
                            ...
                            <button type="button" id="EMR_ASESMEN_DOKTER_btnMurmur" class="btn green col-md-5" value="+"><b> Murmur + </b></button>
                            <button type="button" id="EMR_ASESMEN_DOKTER_btnGallop" class="btn green col-md-5" value="+"><b> Gallop + </b></button>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 collapse" id="EMR_ASESMEN_DOKTER_Halaman6">
                  </div>

                  <div class="btn-group btn-group-circle btn-group-solid" style="width:100%">
                    <button type="button" id="EMR_ASESMEN_DOKTER_HalamanBack" class="btn white" style="width:50%"><< Kembali</button>
                    <button type="button" id="EMR_ASESMEN_DOKTER_HalamanNext" class="btn white" style="width:50%">Lanjutkan >></button>
                  </div>
            ...
            <div class="row portlet-body" id="EMR_ASESMEN_AWAL_verPerPerawat">
              ...
              <div class="col-sm-12">
                <div class="btn-group btn-group btn-group-justified">
                  <a id="EMR_ASESMEN_AWAL_btnChangePerPerawat1" class="btn red"> Klik disini apabila anda bukan <?php echo $level; ?> <?php echo $username; ?></a>
                </div>
              </div>
            </div>
              ...
              <div id="EMR_ASESMEN_DOKTER_btnCommand" class="collapse">
                <div class="btn-group btn-group btn-group-justified">
                  <input type="hidden" id="EMR_ASESMEN_AWAL_userPerPerawatHalDok" name="EMR_ASESMEN_AWAL_userPerPerawatHalDok" value="">
                    <!--<button type="button" class="btn btn-default" id="EMR_ASESMEN_AWAL_btnkembali" style="width:50%">Kembali</button>-->
