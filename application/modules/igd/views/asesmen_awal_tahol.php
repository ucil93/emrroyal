                        ...
                        <div class="portlet light bordered form-body">
                          <div class="row">
                                        ...
                                        <div class="form-group">
                                          <div class="input-group">
                                            <div class="md-radio-inline">
                                              <div class="md-radio">
                                                <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnHambatanYA" name="EMR_ASESMEN_PERAWAT_RbtnHambatan" class="md-radiobtn">
                                              ...
                                              <div class="md-radio">
                                                <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnHambatanTIDAK" name="EMR_ASESMEN_PERAWAT_RbtnHambatan" class="md-radiobtn">
                            ...
                            <div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_Halaman4">
                              <div class="col-md-12">
                                <div class="col-md-12 portlet light bordered">
                                  <span>Apakah Pasien Memiliki Nyeri?</span>

                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="md-radio-inline">
                                        <div class="md-radio">
                                          <input type="radio" id="EMR_ASESMEN_PERAWAT_SN1Ada" name="EMR_ASESMEN_PERAWAT_adaNyeri" class="md-radiobtn">
                                        ...
                                        <div class="md-radio">
                                          <input type="radio" id="EMR_ASESMEN_PERAWAT_SN1Takda" name="EMR_ASESMEN_PERAWAT_adaNyeri" class="md-radiobtn">
                                        ...
                                        <div class="col-md-12 collapse" id="EMR_ASESMEN_PERAWAT_SN3_5">
                                          ...
                                          <div class="form-group">
                                            <div class="input-group">
                                              <div class="md-radio-inline">
                                                <div class="md-radio">
                                                  <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnSNsetiapinsan1" name="EMR_ASESMEN_PERAWAT_RbtnSNsetiapinsan" class="md-radiobtn">
                                                  <label for="EMR_ASESMEN_PERAWAT_RbtnSNsetiapinsan1">
                                                  <span></span>
                                                  <span class="check"></span>
                                                  <span class="box"></span> nyeri sesaat</label>
                                                </div>
                                                <div class="md-radio">
                                                  <input type="radio" id="EMR_ASESMEN_PERAWAT_RbtnSNsetiapinsan2" name="EMR_ASESMEN_PERAWAT_RbtnSNsetiapinsan" class="md-radiobtn">
