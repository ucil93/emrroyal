...
var sn6 = '';
var lergi = '';
var EMR_ASESMEN_AWAL_emoticon = document.getElementById('EMR_ASESMEN_AWAL_emoticon');
...
$('#tinggibadan').keyup(function() {
  ...
  if(beratbadan.value != '' && tinggibadan.value != '')
  {
    //Nilai_BMI.innerHTML = beratbadan.value/(tinggibd*tinggibd);
    var Nilai_BMI2 = beratbadan.value/(tinggibd*tinggibd);
    var satuanBMI = 'Kg/m<sup>2</sup>'
    Nilai_BMI.innerHTML = Nilai_BMI2.toFixed(2) + " " + satuanBMI;
...
$('#EMR_ASESMEN_PERAWAT_SN1Ada').click(function() {
  ...
  if(EMR_ASESMEN_PERAWAT_SN1Ada.checked == true)
  {
    ...
    sn5 = '';
    sn6 = '';
    EMR_ASESMEN_AWAL_emoticon.style.visibility="hidden";
    //$("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/1.png");
  }
  else
  {
    halaman3 = 'Tidak';
    ...
    EMR_ASESMEN_PERAWAT_HalamanNext.classList.add('white');
    EMR_ASESMEN_PERAWAT_HalamanNext.classList.remove('green');
    EMR_ASESMEN_AWAL_emoticon.style.visibility="visible";
  }
});
...
$('#EMR_ASESMEN_PERAWAT_SN_NIPSA1').click(function() {
  ...
  if (tindakSN >= 0 && tindakSN < 2)
  {
    $("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/1.png");
  }
  else if (tindakSN >= 2 && tindakSN < 4)
  {
    $("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/2.png");
  }
  else if (tindakSN >= 4 && tindakSN < 6)
  {
    $("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/3.png");
  }
  else if (tindakSN >= 6 && tindakSN < 8)
  {
    $("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/4.png");
  }
  else if (tindakSN >= 8 && tindakSN < 10)
  {
    $("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/5.png");
  }
  else if (tindakSN >= 10)
  {
    $("#EMR_ASESMEN_AWAL_emoticon").attr("src",base_url + "assets/pages/img/emoticon/6.png");
  }
});
